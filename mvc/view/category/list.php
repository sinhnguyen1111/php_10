        ...
        <table class="table">
            ...
            <?php foreach ($categories as $item) {?>
		        ...
		        <tr>
		            ...
		            <td>
		                <a href="index.php?mod=category&act=show&id=<?php echo $item['id'] ?>" class="btn btn-primary">Detail</a>
		                <a href="index.php?mod=category&act=edit&id=<?php echo $item['id'] ?>" class="btn btn-success">Edit</a>
		                <a href="index.php?mod=category&act=delete&id=<?php echo $item['id']?> " class="btn btn-danger">Delete</a>
		            </td>
		        </tr>
        	<?php }?>
        </table>
